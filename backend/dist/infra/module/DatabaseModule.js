...
const UnitOfWork_1 = __importDefault(require("../database/UnitOfWork"));
        ...
        providers: [
            {
                ...
                useFactory: () => new DatabaseConnection_1.default((0, Env_1.requireEnv)("DATABASE_URL")),
            },
            { provide: "UnitOfWork", useClass: UnitOfWork_1.default },
        ],
