...
const collectCandidates = (openNotes, scannedCode, isEligible) => openNotes
 ...
 */
export function resolveScan(openNotes, scannedCode) {
    const pendingMatch = selectBestCandidate(collectCandidates(openNotes, scannedCode, isPending));
    ...
    const exceededMatch = selectBestCandidate(collectCandidates(openNotes, scannedCode, isFullyConfirmed));
...
//# sourceMappingURL=resolveScan.js.map