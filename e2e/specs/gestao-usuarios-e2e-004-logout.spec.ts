...
/**
 * E2E-004 — Logout visível em qualquer tela (US-002).
 *
...
for (const account of ACCOUNTS) {
  test(`E2E-004: ${account.label} sai pelo botão da tela e perde o acesso às rotas protegidas`, async ({
    page,
  }) => {
    ...
    // Act — o botão de sair está visível na própria tela, sem menu escondido
